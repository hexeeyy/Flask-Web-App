...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:hexilon@localhost/flask_hhh?auth_plugin=mysql_native_password' # Replace with your MySQL connection details
